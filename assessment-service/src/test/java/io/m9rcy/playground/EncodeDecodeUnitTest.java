...
public class EncodeDecodeUnitTest {
    ...
    private static final String IN_FILE = "/Users/m9rcy/Downloads/sample_5mb.pdf";// path to file to be encoded from;
    private static final String OUT_FILE = "/Users/m9rcy/Downloads/sample_5mb_out.pdf";// path to file to be decoded into;
    ...
    @Test
    public void givenJavaBase64_whenEncodedString_thenDecodedOK() throws IOException {
        String encodedString = java.util.Base64.getEncoder().encodeToString(inFileBytes);
        byte[] decoded = java.util.Base64.getDecoder().decode(encodedString);

        writeToFile("/Users/m9rcy/Downloads/sample_5mb_pdf.txt", encodedString.getBytes());
